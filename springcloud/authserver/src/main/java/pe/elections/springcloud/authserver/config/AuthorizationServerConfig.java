package pe.elections.springcloud.authserver.config;
...
import pe.elections.springcloud.authserver.jose.Jwks;
...
public class AuthorizationServerConfig {
    ...
    public AuthorizationServerSettings authorizationServerSettings() {
        return AuthorizationServerSettings.builder().issuer("http://authserver:9999").build();
    }
